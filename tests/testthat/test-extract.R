...
test_that("warning messages work", {
        expect_warning(fingertips_data(IndicatorID = 1107, DomainID = 1938133055),
        ...
        expect_warning(fingertips_data(IndicatorID = 1107, AreaTypeID = 102, ParentAreaTypeID = 101),
...
test_that("error messages work", {
        ...
        expect_error(fingertips_data(IndicatorID = 1107, AreaTypeID = "hello"),
                     "Invalid AreaTypeID\\. Use function area_types\\(\\) to see what values can be used\\.")
        expect_error(fingertips_data(IndicatorID = 1107, AreaTypeID = NULL),
