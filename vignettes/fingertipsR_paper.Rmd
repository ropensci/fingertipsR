...
The data can be accessed from <https://fingertips.phe.org.uk> where the data can be visualised in variety of ways including heatmaps, choropleth maps, line charts for trends, scatter plots and so on.
