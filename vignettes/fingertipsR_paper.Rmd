...
Data can be also be exported for a group of indicators, for a single geography per download. 
...
Use of an API is highly technical and not always suited to the public health researcher. 
