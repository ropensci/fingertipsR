...
The data can be accessed from <https://fingertips.phe.org.uk> where the data are visualised in variety of ways including heatmaps, choropleth maps, line charts for trends, "spine" charts, which compare multiple indicators for a single area, scatter plots and so on.
...
However, before they can do so, they need to check what geographies are represented as the indicators data are not always available at all geographies.
...
The package was developed openly on [GitHub](https://GitHub.com/PublicHealthEngland/fingertipsR), an online location where computer code is stored, where it is carefully version controlled through Git software.
...
<!--SF I think this is a useful summarising sentence.-->
...
Additional suggestions for future updates are:
...
At the date of writing, the package itself has been downloaded 607 times, 30 issues have been raised and 4 researchers have contributed to the project repository. 
